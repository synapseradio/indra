import type { ActorDef, Program } from "../types.ts";
  ...
  perform: {
    ...
    then: [
      // State 1: no user input yet — welcome and invite.
      {
        when: {
          kind: "is",
          left: { kind: "ref", path: { ns: "dialogue", segments: ["latest_dialogue_entry"] } },
        ...
        sets: [
          {
            ...
            value: { kind: "ref", path: { ns: "dialogue", segments: ["latest_dialogue_entry"] } },
            level: "perform",
          },
        ],
        terminator: {
