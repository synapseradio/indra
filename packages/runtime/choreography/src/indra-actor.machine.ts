import type { ActorDef, Json, TurnOutcome } from "@indra/runtime-contracts";
import {
  type AnyActorRef,
 ...
 */
export interface IndraActorInput {
  readonly blueprint: ActorDef;
  readonly actors: Record<string, ActorDef>;
}

export interface IndraActorContext {
  blueprint: ActorDef;
