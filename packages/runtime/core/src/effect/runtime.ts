import type { World } from "@indra/runtime-contracts";
import { Layer, ManagedRuntime } from "effect";
import type { Inference } from "~/baml/inference";
import { ContextStoreLayer, type ContextStoreTag } from "./context-store.layer";
