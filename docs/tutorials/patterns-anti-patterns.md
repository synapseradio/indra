      ...
      you:
        perform:
          ...
          then:
            ...
            with:
              new_depth: «${conversation_depth + 1}»
...
```indra
# TOO BINARY
guard: is_valid == true and has_permission == true and not is_blocked
```

### ✅ Right: Contextual Guards

```indra
# CONTEXTUAL
guard: ‹request seems legitimate and authorized›
```
